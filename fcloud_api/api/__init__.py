...
zt_api = Blueprint('mana_api', __name__)


from fcloud_api.api import netflow
from fcloud_api.api import pm_mana
from fcloud_api.api.vm import nova
from fcloud_api.api.vm import identity
from fcloud_api.api.vm import vm_monitor